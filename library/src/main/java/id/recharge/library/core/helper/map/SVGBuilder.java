package id.recharge.library.core.helper.map;
...
public class SVGBuilder
{
     ...
     *
     * @param svgData the input stream, with SVG XML data in UTF-8 character
     *                encoding.
     ...
     * @param searchColor    The colour in the SVG.
     * @param replaceColor   The desired colour.
     * @param overideOpacity If true, combines the opacity defined in the SVG resource with
     *                       the alpha of replaceColor.
     */
    ...
    /**
     * Applies a {@link ColorFilter} to the paint objects used to render the
     * SVG.
     */
    ...
    /**
     * Whether or not to close the input stream after reading (ie. after calling
     * {@link #build()}.<br>
