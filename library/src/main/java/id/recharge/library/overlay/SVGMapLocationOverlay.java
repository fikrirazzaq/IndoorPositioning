package id.recharge.library.overlay;
...
public class SVGMapLocationOverlay extends SVGMapBaseOverlay {
    ...
    private static final int DEFAULT_LOCATION_COLOR_1 = 0xFFC93EB5;

    private static final int DEFAULT_LOCATION_COLOR_2 = 0xFFC93E3E;

    private static final int DEFAULT_LOCATION_COLOR_3 = 0xFFC9A03E;
    ...
    public SVGMapLocationOverlay(SVGMapView svgMapView, String filter) {
        initLayer(svgMapView, filter);
    }

    private void initLayer(SVGMapView svgMapView, String filter) {
        ...
        switch (filter) {
            case "kalman1":
                locationPaint.setColor(DEFAULT_LOCATION_COLOR_1);
                break;
            case "kalman2":
                locationPaint.setColor(DEFAULT_LOCATION_COLOR_2);
                break;
            case "feedback":
                locationPaint.setColor(DEFAULT_LOCATION_COLOR_3);
                break;
            default:
        ...
        //
        defaultLocationCircleRadius = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 8, svgMapView.getResources().getDisplayMetrics());
        //
        compassRadius = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 38, svgMapView.getResources().getDisplayMetrics());
        compassLocationCircleRadius = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 0.5f, svgMapView.getResources().getDisplayMetrics());
        compassLineWidth = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 1.3f, svgMapView.getResources().getDisplayMetrics());
        compassLineLength = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2.3f, svgMapView.getResources().getDisplayMetrics());
        compassArcWidth = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 4.0f, svgMapView.getResources().getDisplayMetrics());
        compassIndicatorCircleRadius = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 2.6f, svgMapView.getResources().getDisplayMetrics());
        compassIndicatorGap = TypedValue
                .applyDimension(TypedValue.COMPLEX_UNIT_DIP, 15.0f, svgMapView.getResources().getDisplayMetrics());
        //
            ...
            if (currentMode == MODE_COMPASS) {
                for (int i = 0; i < 360 / COMPASS_DELTA_ANGLE; i++) {
                    ...
                    if (i % (90 / COMPASS_DELTA_ANGLE) == 0) {
                        canvas.drawLine(goal[0], goal[1] - compassRadius + compassLocationCircleRadius, goal[0],
                                goal[1] - compassRadius + compassLocationCircleRadius - compassLineLength,
                                compassLinePaint);
                    } else {
                ...
                if (compassIndicatorArrowBitmap != null) {
                    ...
                    canvas.drawBitmap(compassIndicatorArrowBitmap,
                            ...
                            goal[1] - defaultLocationCircleRadius - compassIndicatorGap, new Paint());
                    canvas.restore();
                    if (360 - (this.compassIndicatorArrowRotateDegree - this.compassIndicatorCircleRotateDegree)
                            > 180) {
                        canvas.drawArc(
                                new RectF(goal[0] - compassRadius, goal[1] - compassRadius, goal[0] + compassRadius,
                                        goal[1] + compassRadius), -90 + this.compassIndicatorCircleRotateDegree,
                        ...
                        canvas.drawArc(
                                new RectF(goal[0] - compassRadius, goal[1] - compassRadius, goal[0] + compassRadius,
                                        goal[1] + compassRadius), -90 + this.compassIndicatorArrowRotateDegree,
                                360 - (this.compassIndicatorArrowRotateDegree
                                        - this.compassIndicatorCircleRotateDegree), false,
                                indicatorArcPaint);
                    }
